...
import { getPresentations } from '../../../../../../../services/util/editor/presentations';
import styles from './viewPresentations.module.scss';
import moment from 'moment';
import { Loader } from '../../../../../../../components/loader/loader';

export class ViewPresentations extends Component {
    constructor(props) {
        super(props)
    ...
    showPresentation(id) {
        this.props.history.push(`/app/editor-view-presentations/${id}`);
    }

    componentDidMount() {
        let loadData = async () => {
            this.setState({ is_page_loading: true });
            let respond = await getPresentations();
