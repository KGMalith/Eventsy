...
import { getAllSpeakers } from '../../../../../../../services/util/editor/speakers';
import styles from './viewSpeakers.module.scss';
import {Loader} from '../../../../../../../components/loader/loader';

export class ViewSpeakers extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        const LoadSpeakers = async () => {
            ...
            let respond = await getAllSpeakers();
            if (respond.success) {
    ...
    LoadEditSpeaker(id) {
        this.props.history.push(`/app/editor-speakers/${id}`);
    }
    render() {
        return (
            <div>
