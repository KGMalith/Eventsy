...
export class EditPendingConference extends Component {
    constructor(props) {
        super(props)
                ...
                {this.state.is_page_loading === true ?
                    ...
                    <Container fluid>
                        <Col sm={{ span: 10, offset: 1 }}>
                            <Card>
                                <Card.Header>
                                    <Card.Title className={styles.cardTitle}>Edit Pending Conference</Card.Title>
                                </Card.Header>
                                <Card.Body>
...
export default EditPendingConference;
