...
import styles from './viewWorkshopProposal.module.scss';
import { Button, Card, Col, Container, Image, Row } from 'react-bootstrap';
import { CustomButton } from '../../../../../../../components/buttons';
import { Document, Page, pdfjs } from 'react-pdf';
import { useParams, useHistory } from 'react-router-dom';
import { Loader } from '../../../../../../../components/loader/loader';
import { reviewerAcceptWorkshopPaper, reviewerGetWorkshopProposal, reviewerRejectWorkshopPaper } from '../../../../../../../services/util/reviewer/workshop proposals';
pdfjs.GlobalWorkerOptions.workerSrc = `//cdnjs.cloudflare.com/ajax/libs/pdf.js/${pdfjs.version}/pdf.worker.js`

function ViewWorkshopProposal() {

    let [is_page_loading, set_page_loading] = useState(false);
    let [workshop_paper, set_workshop_paper] = useState({});
                    ...
                    <Col lg={{ span: 10, offset: 1 }} className='mb-4'>
                        <Card className={styles.actionCard}>
                            <Card.Body className={styles.actionCardBody}>
                                <Row>
                                    <Col xs={4} lg={2}>
                                        <Image src={workshop_paper.workshop_conductor_image ? workshop_paper.workshop_conductor_image : `${process.env.REACT_APP_BASE_URL}/images/dummy-avatar.png`} className={styles.workshopConductorImage} />
                                    </Col>
                                    <Col className='align-self-center'>
                                        <p className={styles.workshopConductorName}>{workshop_paper.workshop_conductor_name}</p>
                                        <p className={styles.workshopConductorEmail}>{workshop_paper.workshop_conductor_email_address}</p>
                                    </Col>
                                        ...
                                        <Row>
                                            <Col>
                                                <CustomButton
                                                    ...
                                                    label='Accept'
                                                    handleClick={() => AcceptWorkshopPaperRequest()}
                                            ...
                                            <Col>
                                                <CustomButton
                                                    classType='dangerBtn'
                                                    label='Reject'
                                                    handleClick={() => RejectWorkshopPaperRequest()}
                                                    buttonDisabled={submissionLoading ? true : false}
                                                />
                                            </Col>
                                        </Row>
                        ...
                        <Card className={styles.cvViewCard}>
                            <Card.Header className={styles.cardHeader}>
                                <div className={styles.headerDetails}>
                                    <p className={styles.accordianHeaderTopic}><b>CV of</b>&nbsp;&nbsp;{workshop_paper.workshop_conductor_name}</p>
...
export default ViewWorkshopProposal
